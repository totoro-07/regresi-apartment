# -*- coding: utf-8 -*-
"""Predictive Analytics Sewa Apartment.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1pjec-aCisgHijGs4r6q3N3AN-jcGZVBy
...
| -------------- | ----------- | ---------- |
| `amenities`    | 3.549       | 35.5%      |
| `bathrooms`    | 34          | 0.34%      |
| `bedrooms`     | 7           | 0.07%      |
| `pets_allowed` | 4.163       | 41.6%      |
| `address`      | 3.327       | 33.3%      |
| `cityname`     | 77          | 0.77%      |
| `state`        | 77          | 0.77%      |
| `latitude`     | 10          | 0.1%       |
